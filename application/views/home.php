                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            ?>
                            <img class="rounded-circle header-profile-user" src="<?= base_url('uploads') . '/' . $photo ?>" alt="Header Avatar">
                            <span class="d-none d-sm-inline-block ml-1"><?= $this->session->userdata('logged_in')->username ?></span>
                            <i class="mdi mdi-chevron-down d-none d-sm-inline-block"></i>
                        </button>
                        <div class="dropdown-menu dropdown-menu-right">
                            <!-- item-->
                            <a class="dropdown-item" href="<?= base_url('profile') ?>"><i class="mdi mdi-face-profile font-size-16 align-middle mr-1"></i> Profile</a>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <?php if ($this->session->userdata('logged_in')->role == 'admin') : ?>
                            <li>
                                <a href="<?= base_url('user_management') ?>" class="waves-effect">
                        ...
                        <?php endif; ?>
                        <!-- <li>
                                <a href="<?= base_url('inventaris') ?>" class="waves-effect">
                                    <div class="d-inline-block icons-sm mr-1"><i class="uim uim-box"></i></div>
                                    <span>Inventaris</span>
                                </a>
                            </li> -->
                        <li>
                            <a href="<?= base_url('ruang') ?>" class="waves-effect">
                        ...
                        <li>
                            <a href="<?= base_url('divisi') ?>" class="waves-effect">
                                <div class="d-inline-block icons-sm mr-1">
                                    <i class="uim uim-box"></i>
                                    <span>Divisi</span>
                                </div>
                        ...
                        <li>
                            <a href="<?= base_url('data') ?>" class="waves-effect">
                                <div class="d-inline-block icons-sm mr-1">
                                    <i class="uim uim-box"></i>
                                    <span>Data</span>
                                </div>
